...
using ApacheJenaSample.Csv.Ncar.Converter;
using ApacheJenaSample.Csv.Ncar.Model;
using ApacheJenaSample.Csv.Ncar.Model.Enums;
using TinyCsvParser.Mapping;

namespace ApacheJenaSample.Csv.Ncar.Mapper
{
